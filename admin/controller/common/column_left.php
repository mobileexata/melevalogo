...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$menus = [
				[
					'menu' => 'extension/module/ocslideshow/update',
					'name' => 'Editar slide inicial',
					'module_id' => 'ocslideshow_id=19',
					'icon' => 'fa-slideshare',
					'id' => 'menu-slide-inicial',
				],
				[
					'menu' => 'extension/module/ocmegamenu/edit',
					'name' => 'Editar menu desktop',
					'module_id' => 'menu_id=1',
					'icon' => 'fa-bars',
					'id' => 'menu-inicial',
				],
				[
					'menu' => 'extension/module/ocmegamenu/edit',
					'name' => 'Editar menu mobile',
					'module_id' => 'menu_id=2',
					'icon' => 'fa-bars',
					'id' => 'menu-inicial',
				],
				[
					'menu' => 'extension/module/newslettersubscribe',
					'name' => 'Newsletter',
					'module_id' => 'module_id=39',
					'icon' => 'fa-newspaper-o',
					'id' => 'menu-newsletter',
				],
				[
					'menu' => 'extension/module/ocproduct',
					'name' => 'Produtos mais vendidos',
					'module_id' => 'module_id=248',
					'icon' => 'fa-percent',
					'id' => 'menu-produtos-mais-vendidos',
				],
				[
					'menu' => 'extension/payment/rede_rest_credito',
					'name' => 'Config Cartão Crédito',
					//'module_id' => 'module_id=248',
					'icon' => 'fa-dollar',
					'id' => 'menu-config-cc',
				],
				[
					'menu' => 'extension/payment/rede_rest_debito',
					'name' => 'Config Cartão Débito',
					//'module_id' => 'module_id=248',
					'icon' => 'fa-dollar',
					'id' => 'menu-config-cd',
				],
			...
			foreach ($menus as $menu)
				$data['menus'][] = array(
					...
					'icon'	   => $menu['icon'],
					'name'	   => $menu['name'],
					'href'     => $this->url->link($menu['menu'], 'user_token=' . $this->session->data['user_token'], true) . (isset($menu['module_id']) ? '&'. $menu['module_id'] : ''),
					'children' => array()
				);
