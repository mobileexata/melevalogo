$(document).ready(function () {
    ...
    $('.oc-menu').each(function () {
        ...
        if ($mobile) {
            ...
            $(this).find('.li-second-items').click(function () {
                var flag = $(this).find('.second-click-show').closest('.li-second-items').hasClass('expand');

                if (flag) {

                    $(this).find('.second-click-show').closest('.li-second-items').removeClass('expand');

                    if (effect == "none") {
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').hide();
                    }

                    if (effect == "fade") {
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').fadeOut('slow');
                    }

                    if (effect == "slide") {
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').slideUp();
                    }
                } else {
                    $('.li-second-items').removeClass('expand');

                    $(this).find('.second-click-show').closest('.li-second-items').addClass('expand');

                    if (effect == "none") {
                        $('.mobile-menu .flyout-third-items').hide();
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').show();
                    }

                    if (effect == "fade") {
                        $('.mobile-menu .flyout-third-items').fadeOut('slow');
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').fadeIn('slow');
                    }

                    if (effect == "slide") {
                        $('.mobile-menu .flyout-third-items').slideUp();
                        $(this).find('.second-click-show').closest('.li-second-items').find('.flyout-third-items').slideDown('slow');
                    }
                }
            });
        } else {
    ...
    $('.oc-menu.mobile-menu').find('a[class="a-top-link a-item"][href="javascript:void(0)"]').each(function () {
